...
_DESCRIPTION = """\
KaWAT contains word analogy task for Indonesian.
"""
...
_SUPPORTED_TASKS = [Tasks.SEMANTIC_SIMILARITY]  # example: [Tasks.TRANSLATION, Tasks.NAMED_ENTITY_RECOGNITION, Tasks.RELATION_EXTRACTION]
...
class Kawat(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        NusantaraConfig(
            name="kawat_nusantara_[nusantara_schema_name]",
